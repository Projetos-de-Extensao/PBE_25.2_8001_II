...
- **professor**: (futuro uso)
- **coordenador**: Cria e gerencia monitorias
...
1. ✅ Backend com API REST completa
2. ✅ Autenticação JWT integrada
3. ✅ Serviço de API no frontend
4. ⏳ Atualizar componentes do frontend para usar API real
